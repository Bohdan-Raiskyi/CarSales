...
namespace CarSalesInfrastructure.Controllers
{
    public class CarBrandsController : Controller
    {
        ...
        public CarBrandsController(CarSalesContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("BrandName,Id")] CarBrand carBrand)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BrandName,Id")] CarBrand carBrand)
        {
            if (id != carBrand.Id)
            {
                return NotFound();
